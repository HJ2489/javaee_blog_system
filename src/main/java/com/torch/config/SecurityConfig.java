...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers("/admin/**").hasRole("admin")  // admin下的路径只有权限为admin才能访问
        ...
        // 3、设置用户登录后cookie有效期，默认值(在配置文件application.yml中设置了，为30min)
    ...
    /**
     * 重写configure(AuthenticationManagerBuilder auth)方法，进行自定义用户认证，查询用户权限
     * @param auth
     * @throws Exception
     */
    @Override
